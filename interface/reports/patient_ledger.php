...
<form method='post' action='patient_ledger.php' id='theform'>
 ...
 <tr>
  <td width='70%'>
	...
	<table class='text'>
      ...
      <td><span class='label'><?php xl('Patient','e'); ?>:&nbsp;&nbsp;</span></td>
      <td>
			...
			<?php if ($_REQUEST['form_refresh'] || $_REQUEST['form_csvexport']) { ?>
					<div id="controls">
                     <a href="../patient_file/summary/demographics.php" <?php if (!$GLOBALS['concurrent_layout']) echo "target='Main'"; ?> class="css_button" onclick="top.restoreSession()">
                         <span><?php echo htmlspecialchars(xl('Back To Patient'),ENT_NOQUOTES);?></span></a>
